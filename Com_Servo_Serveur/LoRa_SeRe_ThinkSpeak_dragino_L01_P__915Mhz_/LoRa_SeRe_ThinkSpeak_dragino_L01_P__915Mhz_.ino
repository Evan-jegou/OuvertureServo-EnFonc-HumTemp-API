...
String myWriteAPIString = "0UYVCQON2LURRNFR";
...
{    
  HttpClient client;
  String data = *Data;
  String url = "https://api.thingspeak.com/update?api_key=0UYVCQON2LURRNFR&field1=";
  url.concat(data);
  client.get(url); 

  url = "http://api.openweathermap.org/data/2.5/weather?lat=50.6306376&lon=3.2383226&units=metrics&appid=65cac0f456f55747c7f58e9ba1e824d0";
  client.get(url); 
